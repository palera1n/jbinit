...
apple-include: apple-include-private/**
	...
	cp -af $(MACOSX_SYSROOT)/usr/include/{arpa,bsm,hfs,net,xpc,netinet,servers,timeconv.h,launch.h,libproc.h} apple-include
	...
	cp -af $(MACOSX_SYSROOT)/usr/include/sys/{tty*,proc_info,ptrace,kern*,random,reboot,user,vnode,disk,vmmeter,conf}.h apple-include/sys
